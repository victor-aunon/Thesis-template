...
% Numbersfont font size
\newcommand{\numbersFontSize}{12pt}
% Numbersfont line spacing
\newcommand{\numbersLineSpacing}{13.2pt} % \fontSize * 1.2 (1.1, 1.2, 1.3, ...)
...
\usepackage{graphicx}       % graphs package, draft option to avoid 
                            % rendering figures
...
\usepackage{hyphenat}       % package to avoid hyphenation on demand
...
\usepackage{supertabular}   % jpackage to create big tables
...
\usepackage[switch, modulo, pagewise]{lineno} % package to enumerate the lines,
                            % useful for reviewing.
                            % Options-> switch: numbers on the
                            ...
                            % multiple of five, pagewise: reset count on newpage
...
% Maximum mini-TOC depth level: subsubsection
\setcounter{minitocdepth}{4}
% Maximum document depth level: subsubsection
\setcounter{secnumdepth}{4}
% Maximum TOC depth level: subsubsection
\setcounter{tocdepth}{3}

% Avoid hyphenation in TOC - OPTIONAL
\makeatletter
\renewcommand{\@tocrmarg}{\@pnumwidth plus1fil}
\makeatother

% Reduce indent of section titles in TOCs
\renewcommand*{\cftsecindent}{2em}
% Reduce indent of subsection titles in TOCs
\renewcommand*{\cftsubsecindent}{3em}
% Reduce indent of subsubsection titles in TOCs
...
%http://tex.stackexchange.com/questions/10682/suppress-in-biblatexo

% Parenthesis between volume in article instead of dot when using default 
% author-year style
...
% Puts a text in red "To be referenced" that will point to a reference in the 
% future
\newcommand{\emptycite}{\textcolor{red}{[TO BE REFERENCED]}}
...
\titleformat*{\subsection}{\subsectionfont\bfseries\fontsize{14pt}{21pt}%
\selectfont}
\titleformat*{\subsubsection}{\subsubsectionfont\fontsize{12pt}{18pt}%
\selectfont}
...
% Figure captions in italic and colored according to \accentColor
...
\renewcommand{\epigraphwidth}{0.7\linewidth}
